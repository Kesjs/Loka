    ...
    <div className="min-h-screen overflow-x-hidden bg-white font-sans text-neutral-900 selection:bg-primary-100 selection:text-primary-900">
      ...
      <main id="accueil" className="pt-[76px]">
        ...
        <section id="preuve" aria-labelledby="proof-title" className="scroll-mt-24 border-y border-primary-100 bg-neutral-50">
          <div className="mx-auto max-w-[1240px] px-5 py-10 sm:px-6 lg:px-10">
            <div className="grid gap-8 lg:grid-cols-[1.1fr_1.9fr] lg:items-center">
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {proofStats.map((stat, index) => (
                  ...
                  >
                    <p className={`text-2xl font-bold tracking-[-0.05em] ${index === 1 ? "text-accent-600" : "text-neutral-950"}`}>{stat.value}</p>
            ...
            <Reveal delay={0.1} className="mt-8 flex flex-wrap items-center gap-3 border-t border-neutral-200 pt-6">
              ...
              {["MTN Mobile Money", "Moov Money", "Carte bancaire"].map((method) => (
                <span
                  key={method}
                  className="inline-flex items-center gap-1.5 rounded-full border border-neutral-200 bg-white px-3 py-1.5 text-xs font-bold text-neutral-700 shadow-xs"
                >
